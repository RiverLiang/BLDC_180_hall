...
volatile asm void _vect(void) {
  ...
  JSR  FMSTR1_Isr                      /* Interrupt no. 9 (Used)   - ivINT_TX_REG  */
  JSR  FMSTR1_Isr                      /* Interrupt no. 10 (Used)   - ivINT_RX_REG  */
  ...
  JSR  Cap2_Interrupt                  /* Interrupt no. 26 (Used)   - ivINT_TMRA_2  */
  JSR  Cap1_Interrupt                  /* Interrupt no. 27 (Used)   - ivINT_TMRA_1  */
  JSR  Cap0_Interrupt                  /* Interrupt no. 28 (Used)   - ivINT_TMRA_0  */
  ...
  JSR  PWM_RELOAD_ISR                  /* Interrupt no. 86 (Used)   - ivINT_eFlexPWMA_RELOAD0  */
  ...
  JSR  PIT_1ms_Interrupt               /* Interrupt no. 95 (Used)   - ivINT_PIT0_ROLLOVR  */
...
/*lint -esym(765,Cap2_Interrupt) Disable MISRA rule (8.10) checking for symbols (Cap2_Interrupt). */
/*lint -esym(765,Cap1_Interrupt) Disable MISRA rule (8.10) checking for symbols (Cap1_Interrupt). */
/*lint -esym(765,Cap0_Interrupt) Disable MISRA rule (8.10) checking for symbols (Cap0_Interrupt). */
/*lint -esym(765,PWM_RELOAD_ISR) Disable MISRA rule (8.10) checking for symbols (PWM_RELOAD_ISR). */
/*lint -esym(765,PIT_1ms_Interrupt) Disable MISRA rule (8.10) checking for symbols (PIT_1ms_Interrupt). */
